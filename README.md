...
The executable program and readme is available for Download within the [TR Developer Platform](https://developers.thomsonreuters.com/system/files/SpeedGuideTool-20160816.zip).
